(function (window) {
  ...
  function CanIUse() {
    ...
    ///
    this.crossDocumentMessaging = function () {
      return !!window.postMessage;
    };

    this.dragAndDrop = function () {
      return 'draggable' in this._createElement('span')
    };
    ...
    this.microdata = function () {
      return !!document.getItems;
    };

    this.offlineWebApplication = function () {
      return !!window.applicationCache;
    };

    this.serverSentEvents = function () {
